...
const progressFile = path.resolve(__dirname, "affiliateProgress.json");
...
const FAILED_RECORDS_PATH = path.join(
  __dirname,
  "failedCollectionsWorkaffiliate.json"
);

/**
 * Saves a collection ID under a specific key (e.g., 'affiliates')
