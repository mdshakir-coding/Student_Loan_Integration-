...
function buildHubSpotClientPayload(data = {}) {
  ...
  const properties = cleanProps({
    ...
    studentaidgov_user_not_0: data?.studentaidgov_user_not_0 || null,
    studentaidgov_pass_not_0: data?.studentaidgov_pass_not_0 || null,
  ...
  : null,
    ...
    first_year_of_payment: data?.first_year_of_payment || null,
    pp_tags_active: data?.pp_tags_active || null,
    ...
    current_ffel_loans: data?.current_ffel_loans || null,
