...
async function processClient(
  record = {
    collection_id: "84",
    site_id: "1",
    fields_changed: "0,13538,15497,12287,15587,15558,15274,13864,15357,15358,0",
    created_by: "11",
    created_date: "2016-08-10 17:54:58",
    modified_by: "53",
    modified_date: "2026-01-20 08:30:51",
    lead_owner: "0",
    phone_1_type: "11174",
    phone_2: "",
    phone_2_type: "11177",
    ...
    spouse__partner: "0",
    referral: "0",
    msa_sent_: "2024-03-18",
    msa_received0: "2024-03-18",
    lpa_sent: "2015-11-13",
    lpa_received: "2015-11-13",
    client_action_taken: "2026-01-20 07:30:00",
    idr_app_submitted_date: "2022-06-07 13:33:00",
    days_since_app_sub: "1366",
    recert_date: "2026-07-14 00:00:00",
    error_with_payments: "1",
    date_of_birth: "1977-11-15",
    social_security_number: "463491433",
    primary_phone0: "2812037235",
    primary_phone_type: "11174",
    secondary_phone: "",
    secondary_phone_type: "11177",
    studentaidgov_user_not_0: "talton28",
    studentaidgov_pass_not_0: "Redeye28!",
    employerbusiness_name: "Alsure Services LLC",
    employer_address: "13418 Alpine Mnt Ln",
    employers_city: "Tomball",
    employers_state: "TX",
    reference_1_name: "Jill Alton",
    reference_1_address: "124 Yellowstone Rd.",
    reference_1_city: "Georgetown",
    reference_1_state: "TX",
    reference_1_zip_: "78663",
    reference_2_name: "Broc Domec",
    reference_2_address: "19810 Dayton Springs Dr.",
    reference_2_city: "Cypress",
    reference_2_state: "TX",
    reference_2_zip: "77429",
    spouse__full_name_: "N/A",
    ...
    client_created_date: "2015-12-28 10:19:00",
    aar_fee: "11493",
    q12_provide_info: "1",
    q4_in_forbearance: "1",
    client_name_fulf: "1",
    client_name_fulc: "1",
    reference_1_phone: "5126394156",
    reference_1_relationship: "Mother",
    reference_2_phone: "8329313291",
    reference_2_relationship: "Best Friend",
    employers_zip: "77478",
    roa_sent_to_servicer: "2025-03-18",
    email_address: "travis.alton@allsureservices.com",
    recerts: "1",
    middle_initialname: "J",
    customer_info: "1",
    current_servicer0: "13044",
    status0: "1",
    servicer__username: "talton",
    servicer__password: "Stella28!",
    last_update: null,
    profession0: "13381",
    profession_details: "",
    ...
    self_employed__ein0: "85-1512393",
    meeting_notes: "",
    contact_notes: "",
    ...
    client_consolidation__lo: "DCL, looks like in 2011",
    client_avg_interest_rate: "5.3",
    _of_subsidized_loans_if: "",
    client_current_planidr_h: "RePAYE",
    ...
    state_license_needed: "TX",
    term_only0: "false",
    na_interested_in_securit: "false",
    monthly_premium0: "0.00",
    fyc_est: "0.00",
    date_of_scheduled_followu: null,
    estimations_current_as_of: "2025-03-18",
    calc_raw_results: "",
    client_years_towards_forg0: "",
    enrolled_in_autopay_if_: "",
    client_orig_total_balanc: "$156,462.39",
    client_orig_principal_ba: "$147,872.83",
    est_forgiveness_date0: "2029-05-01",
    field_2nd_date_if_2_sets: null,
    years_until_forgiveness: "-37",
    ...
    intake_call_complete: "2023-04-14",
    ...
    current_year_total_balanc: "156,462.39",
    current_year_principal_ba: "147,872.83",
    ...
    idr_recert_app_sub_deadli: "2026-06-14",
    days_to_dealine: "-100",
    ...
    does_client_have_a_financ: "15183",
    advisors_name: "",
    email0: "",
    phone_number: "",
    advisors_company: "",
    ...
    type_of_idr_app_submitted: "15253",
    multiple_idr_plans: "",
    ...
    first_name: "Travis",
    last_name: "Alton",
    primary_phone: "2812037235",
    email_1: "travis.alton@allsureservices.com",
    days_to_recert: "-130",
    status1: "11556",
    days_since_client_cont: "43",
  }
) {
  try {
    // Build payload
