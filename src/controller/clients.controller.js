...
async function processClient(
  record = {
    ...
    client_income_doc_notes:
      "dolla bills weekly every other week. about three fiddy on a good day. ",
    apc_status: "1",
    ...
    pslf_notes:
      "He works for the gov that's all we know, submitted his PSLF for one month. ",
    ...
    last_meeting_outcome:
      "He lost all his money and house on online gamblings. ",
